...
export class UpdateCaseDTO {
  ...
  private static checkEmptyString(object: { [key: string]: any }, errors: string[]) {
    if (typeof object.caseName === 'string' && object.caseName.trim() === '') errors.push('caseName should not be an empty string');
    if (typeof object.jury === 'string' && object.jury.trim() === '') errors.push('jury should not be an empty string');
    if (typeof object.caseNumber === 'string' && object.caseNumber.trim() === '') errors.push('caseNumber should not be an empty string');
    if (typeof object.applicant === 'string' && object.applicant.trim() === '') errors.push('applicant should not be an empty string');
    if (typeof object.respondent === 'string' && object.respondent.trim() === '') errors.push('respondent should not be an empty string');
  }
}
