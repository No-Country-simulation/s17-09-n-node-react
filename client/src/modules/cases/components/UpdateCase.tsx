...
export const UpdateCase = ({
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    if (res?.status !== 200) {
      ...
      setAlert({
        ...alert,
        message: 'El caso fue actualizado',
        tipe: 'success',
      })
      setShow(true)
    }
    ...
    >
      ...
      >
        <IoMdCloseCircleOutline
          className='hover:text-red-600 h-8 w-8 text-white'
          ...
          <CustomFormControl required sx={{ my: 1, minWidth: '45%' }}>
            ...
            <Select
              ...
              onChange={(event) => {
                setDataForm({
                  ...dataForm,
                  type: event.target.value as typeTipo,
                })
              }}
            >
          ...
          <CustomFormControl required sx={{ my: 1, minWidth: '45%' }}>
            ...
            <Select
              ...
              onChange={(event) => {
                setDataForm({
                  ...dataForm,
                  status: event.target.value as typeStatus,
                })
              }}
            >
      ...
      {alert && show && <Alert severity={alert.tipe}>{alert.message}</Alert>}
    </Container>
  )
}
